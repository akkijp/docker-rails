...
build:
	...
	@docker build \
		--tag rorono/rails:ruby-2.5.5-node-8.15.1 \
		--tag rorono/rails:ruby-2.5.5-node-8.15.1-${COMMIT_HASH} \
		--tag quay.io/rorono/rails:ruby-2.5.5-node-8.15.1 \
		--tag quay.io/rorono/rails:ruby-2.5.5-node-8.15.1-${COMMIT_HASH} \
		./ruby-2.5.5-node-8.15.1
	@docker build \
